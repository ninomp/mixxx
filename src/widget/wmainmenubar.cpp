...
void WMainMenuBar::initialize() {
    ...
    if (CmdlineArgs::Instance().getDeveloper()) {
        ...
        auto pDeveloperCalculateSimilarities = new QAction(calcSimilaritiesText, this);
        pDeveloperCalculateSimilarities->setStatusTip(calcSimilaritiesText);
        pDeveloperCalculateSimilarities->setWhatsThis(
            buildWhatsThis(calcSimilaritiesTitle, calcSimilaritiesText));
        connect(pDeveloperCalculateSimilarities, SIGNAL(triggered()),
                this, SIGNAL(calculateSimilarities()));
